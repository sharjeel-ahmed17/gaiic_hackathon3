...
const sortedData = [...data].sort((a, b) =>
    sortBy === "price-asc" ? a.discountPrice - b.discountPrice :  
      sortBy === "price-desc" ? b.discountPrice - a.discountPrice :  
        
        sortBy === "newest" ? Number(new Date(b._createdAt)) - Number(new Date(a._createdAt)) :  
          0 
  );
